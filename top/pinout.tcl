...
set_instance_assignment PIN_?? -to scl
set_instance_assignment PIN_?? -to sca
set_instance_assignment PIN_?? -to hot_plug_detect
...
set_instance_assignment -name IO_STANDARD "3.3V Schmitt Trigger Input" -to hot_plug_detect
# set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to scl
# set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to sca
